...
router.get("/document/filedata",downloadfile,authRateLimiter)
router.get("/document/filedata/open",openFile)
router.post("/document/delete/document",deletefile)
router.post("/document/addtofolder",filetofolder)
router.post("/document/fileinfolder",fileinfolder)
router.post("/share/file",sharefile,authRateLimiter);
