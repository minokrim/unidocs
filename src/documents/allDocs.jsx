...
//   }, [filteringLogic, orderLogic, searchTerm]);
    ...
    return <main className="flex flex-col h-full items-center">
        ...
        <input type="name" name="search" onChange={(e)=>{setSearchTerm(e.target.value)}} className="w-[15em] border-solid bg-purple-200 md:w-[20em] h-[2em] rounded-2xl pl-5 font-semibold placeholder:font-normal placeholder:text-gray-600" placeholder="Enter file name" />
        </div>
